...
class Action:
    ...
    def format_file(self):
        ...
        try:
            with open(f".\\mail-merge-project-start\\Input\\Names\\invited_names.txt", 'rt') as f:
                names = f.readlines()

            with open(f".\\mail-merge-project-start\\Input\\Letters\\starting_letter.docx") as sl:
