...
def main():
    ...
    try:
        ...
        root = Tk()
        # Load the image
        image = Image.open(".\\Day30-errors,exceptions,json-data\\logo.png")
        ...
        def on_enter_generate(e):
            Generate_Button.config(bg="blue", fg="white")

        def on_leave_generate(e):
            Generate_Button.config(bg="SystemButtonFace", fg="black")

        # Create Generate Password Button
        Generate_Button = Button(text="Generate Password", bg="SystemButtonFace", fg="black", command=generate_password_action)
        ...
        def on_enter_add(e):
            Add_Button.config(bg="blue", fg="white")

        def on_leave_add(e):
            Add_Button.config(bg="SystemButtonFace", fg="black")

        # Create an Add Button
        Add_Button = Button(text="Add", justify="center", width=40, command=add_entry_action, bg="SystemButtonFace", fg="black")
