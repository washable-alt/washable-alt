...
try:
# TODO 1:
    data = pd.read_csv(f".\\Day25-csvdataandpandas\\weather_data.csv")
    #print(data)
    print(type(data))
    #print(data["temp"])
    ...
    #create new csv file
    data.to_csv(f".\\Day25-csvdataandpandas\\new_data.csv")

    # TODO 2:
    data = pd.read_csv(f".\\Day25-csvdataandpandas\\2018_Central_Park_Squirrel_Census_-_Squirrel_Data.csv")
    ...
    df.to_csv(f".\\Day25-csvdataandpandas\\squirrel_count.csv")
