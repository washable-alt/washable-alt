...
def restart_cards():
    ...
    card_index = -1
    card_front_img = PhotoImage(file=".\\Day31-flashcard-capstone\\images\\card_front.png")
    card_back_img = PhotoImage(file=".\\Day31-flashcard-capstone\\images\\card_back.png")
...
def main():
    ...
    try:
        data = pd.read_csv(".\\Day31-flashcard-capstone\\data\\french_words.csv")
